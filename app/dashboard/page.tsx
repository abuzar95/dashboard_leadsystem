    ...
    <div className="page-content" style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
      <header style={{ marginBottom: '30px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          ...
          <p style={{ color: '#64748b', fontSize: '15px' }}>Overview of prospect metrics and analytics</p>
        </div>
        <button
          type="button"
          onClick={fetchAll}
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
          <div style={cardStyle}>
            ...
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{statsLoading ? '—' : (stats?.totalProspects ?? '—')}</div>
          </div>
          <div style={cardStyle}>
            <div style={{ fontSize: '13px', color: '#64748b', marginBottom: '4px' }}>Today&apos;s Prospects</div>
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{statsLoading ? '—' : (stats?.todaysProspects ?? '—')}</div>
          </div>
          <div style={cardStyle}>
            <div style={{ fontSize: '13px', color: '#64748b', marginBottom: '4px' }}>This Week&apos;s Prospects</div>
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{statsLoading ? '—' : (stats?.thisWeeksProspects ?? '—')}</div>
          </div>
          <div style={cardStyle}>
            <div style={{ fontSize: '13px', color: '#64748b', marginBottom: '4px' }}>Assigned Leads</div>
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{statsLoading ? '—' : (stats?.assignedLeads ?? '—')}</div>
          </div>
        </div>
      </section>
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
          <div style={cardStyle}>
            ...
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{lhStatsLoading ? '—' : (lhStats?.totalAssignedProspects ?? '—')}</div>
          </div>
          <div style={cardStyle}>
            <div style={{ fontSize: '13px', color: '#64748b', marginBottom: '4px' }}>Total LC Prospects</div>
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{lhStatsLoading ? '—' : (lhStats?.totalLCProspects ?? '—')}</div>
          </div>
          <div style={cardStyle}>
            <div style={{ fontSize: '13px', color: '#64748b', marginBottom: '4px' }}>Total LNC Prospects</div>
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{lhStatsLoading ? '—' : (lhStats?.totalLNCProspects ?? '—')}</div>
          </div>
          <div style={cardStyle}>
            <div style={{ fontSize: '13px', color: '#64748b', marginBottom: '4px' }}>Today&apos;s Tasks</div>
            <div style={{ fontSize: '28px', fontWeight: 700, color: '#0f172a' }}>{lhStatsLoading ? '—' : (lhStats?.todaysTasks ?? '—')}</div>
          </div>
        </div>
      </section>
